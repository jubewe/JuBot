 ...
 * @param {string} targ2 message or new time
...
async function _timer(tmode, tuser, targ, targ2, targ3, treturn) {
    return new Promise(function (resolve, reject) {
        ...
        switch (tmode) {
            ...
            case 2: {
                if (!(targ ?? undefined)) return reject({ "path": [tmode, 0], "msg": "targ is undefined" });
            ...
            case 3: {
                if (!(targ ?? undefined)) return reject({ "path": [tmode, 0], "msg": "targ (id) is undefined" });
                if (!(targ2 ?? undefined)) return reject({ "path": [tmode, 1, 0], "msg": "targ2 (time) is undefined" });

                if (!files.timers.ids[targ]) return reject({ "path": [tmode, 1, 0], "msg": "timer not found by targ (id)" });

                files.timers.ids[targ].time = files.timers.ids[targ].set_time + targ2;
