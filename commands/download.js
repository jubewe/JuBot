...
module.exports = {
    ...
    exec: async () => {
        ...
        if(j.message._.args()[0]){
            j.send(2, null, `Started downloading, this might take some time Waiting`);
            ...
            (e2, r2) => {
                if(e2){
                    ...
                    j.send(2, null, `Error: Could not download file ${e2.stack} ${e2.message}`);
                } else {
            ...
            j.modules.request.post(url, {method: "GET", encoding: null}, (e, r) => {
                if(e){
                    ...
                    j.send(2, null, `Error: Could not request url (${e.message})`);
                } else {
                    ...
                    j.send(2, null, `👉 Console`);
                }
            })*/
        } else {
            j.send(2, null, `Error: No url given`);
        }
    }
}