        ...
        switch (opt) {
            case "prefix": {
                ...
                if (["reset"].includes(prefix)) {
                    _channel(2, j_.message.channel.id, "prefix")
                        ...
                        .catch(e => {
                            j_.send(`Error: Could not reset prefix: ${_returnerr(e)}`);
                        })
                } else {
                    _channel(1, j_.message.channel.id, "prefix", prefix)
                        ...
                        .catch(e => {
                            j_.send(`Error: Could not set prefix: ${_returnerr(e)}`);
                        })
                }
                        ...
                        _channel(0, j_.message.channel.id, "allowed_commands", undefined, true)
                            .then(a => {
                                ...
                                _channel(1, j_.message.channel.id, "allowed_commands", b)
                                    ...
                                    .catch(e => {
                                        j_.send(`Error: Could not add ${cmdname} to allowed commands: ${_returnerr(e)}`);
                                    })
                            })
                            .catch(e => {
                                j_.send(`Error: Could not add ${cmdname} to allowed commands: Could not get allowed commands of channel: ${_returnerr(e)}`);
                            })
                        break;
                    }
                        ...
                        _channel(0, j_.message.channel.id, "allowed_commands", undefined, true)
                            .then(a => {
                                ...
                                _channel(1, j_.message.channel.id, "allowed_commands", b)
                                    ...
                                    .catch(e => {
                                        j_.send(`Error: Could not remove ${cmdname} from allowed commands: ${_returnerr(e)}`);
                                    })
                            })
                            .catch(e => {
                                j_.send(`Error: Could not remove ${cmdname} from allowed commands: Could not get allowed commands of channel: ${_returnerr(e)}`);
                            })
                        break;
                    }
            ...
            case "valoranttag": {
                ...
                _channel(1, j_.message.channel.id, "valoranttag", encodeURI(tag))
                    ...
                    .catch(e => {
                        j_.send(`Error: Could not set valoranttag to ${tag}: ${_returnerr(e)}`);
                    })
                    ...
                    j.dc.client.guilds.fetch(discord_serverid)
                        .then(() => {
                            _channel(1, j_.message.channel.id, "discord_serverid", discord_serverid)
                                ...
                                .catch(e => {
                                    j_.send(`Error: Could not set discord serverid: ${_returnerr(e)}`);
                                })
                        })
                        .catch(e => {
                            j_.send(`Error: Could not fetch guild: ${_returnerr(e)}`);
                        })
                } else {
            ...
            case "clipchannel": {
                ...
                _channel(1, j_.message.channel.id, "discord_clipchannelid", discord_clipchannelid)
                    ...
                    .catch(e => {
                        j_.send(`Error: Could not set discord clipchannelid: ${_returnerr(e)}`);
                    })
            ...
            case "youtubechannel": {
                ...
                _channel(1, j_.message.channel.id, "youtube_channelid", youtube_channelid)
                    ...
                    .catch(e => {
                        j_.send(`Error: Could not set youtube channelid: ${_returnerr(e)}`);
                    })
            ...
            case "sendclipstodiscord": {
                ...
                _channel(1, j_.message.channel.id, "send_clips_to_discord", send_clips_to_discord)
                    ...
                    .catch(e => {
                        j_.send(`Error: Could not set send_clips_to_discord: ${_returnerr(e)}`);
                    })
                break;
            }
            ...
            case "get": {
                ...
                _channel(0, j_.message.channel.id, j_.message._.args()[1])
                    ...
                    .catch(e => {
                        j_.send(`Error: Could not get setting ${j_.message._.args()[1]}: ${_returnerr(e)}`);
                    })
                break;
            }
