...
export declare class PrivmsgMessage extends ChannelIRCMessage implements PrivmsgUserState {
    ...
    readonly replyParentDisplayName: string | undefined;
    readonly replyParentMessageBody: string | undefined;
    readonly replyParentMessageID: string | undefined;
    readonly replyParentUserID: string | undefined;
    readonly replyParentUserLogin: string | undefined;
