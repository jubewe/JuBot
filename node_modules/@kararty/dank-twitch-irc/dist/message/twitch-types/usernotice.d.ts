...
export interface AnAnnouncementUsernoticeMessage<I extends string, E extends EventParamsMaybe> {
    readonly messageTypeID: I;
    readonly eventParams: E;
}
...
export declare type MassSubgiftUsernoticeMessage = SpecificUsernoticeMessage<"submysterygift", MassSubgiftParameters>;
...
export declare type AnnouncementUsernoticeMessage = AnAnnouncementUsernoticeMessage<"announcement", AnnouncementParameters>;
