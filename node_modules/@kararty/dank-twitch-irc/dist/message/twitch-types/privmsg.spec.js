...
describe("./message/twitch-types/privmsg", function () {
    describe("#parseActionAndMessage()", function () {
        it("should return non-actions unmodified", function () {
            chai_1.assert.deepStrictEqual((0, privmsg_1.parseActionAndMessage)("HeyGuys"), {
                isAction: false,
                message: "HeyGuys",
            });
            chai_1.assert.deepStrictEqual((0, privmsg_1.parseActionAndMessage)("\u0001ACTION HeyGuys"), {
                isAction: false,
            ...
            // missing space
            chai_1.assert.deepStrictEqual((0, privmsg_1.parseActionAndMessage)("\u0001ACTIONHeyGuys\u0001"), {
                isAction: false,
        ...
        it("should remove action prefix and suffix on valid actions", function () {
            ...
            // nested
            chai_1.assert.deepStrictEqual((0, privmsg_1.parseActionAndMessage)("\u0001ACTION \u0001ACTION HeyGuys\u0001\u0001"), {
                isAction: true,
                message: "\u0001ACTION HeyGuys\u0001",
            });
        });
    ...
    describe("PrivmsgMessage", function () {
        it("should be able to parse a real PRIVMSG message", function () {
            ...
            chai_1.assert.isUndefined(msg.replyParentDisplayName);
            chai_1.assert.isUndefined(msg.replyParentMessageBody);
            chai_1.assert.isUndefined(msg.replyParentMessageID);
            chai_1.assert.isUndefined(msg.replyParentUserID);
            chai_1.assert.isUndefined(msg.replyParentUserLogin);
        ...
        it("should be able to parse a real reply PRIVMSG message", function () {
            ...
            const msg = (0, twitch_message_1.parseTwitchMessage)(msgText);
            chai_1.assert.instanceOf(msg, privmsg_1.PrivmsgMessage);
            chai_1.assert.isTrue(msg.isReply());
            chai_1.assert.strictEqual(msg.replyParentDisplayName, "OtherUser");
            chai_1.assert.strictEqual(msg.replyParentMessageBody, "Test: Abc");
            chai_1.assert.strictEqual(msg.replyParentMessageID, "abcd");
            chai_1.assert.strictEqual(msg.replyParentUserID, "123");
            chai_1.assert.strictEqual(msg.replyParentUserLogin, "otheruser");
        });
