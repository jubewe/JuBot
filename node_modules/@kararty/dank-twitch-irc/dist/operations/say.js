...
exports.reply = exports.me = exports.say = exports.SayError = exports.removeCommands = void 0;
...
async function say(conn, channelName, messageText, replyToID, action = false) {
    let command;
    let errorMessage;
    let errorType;
    if (action) {
    ...
    (0, privmsg_1.sendPrivmsg)(conn, channelName, command, replyToID);
    return (0, await_response_1.awaitResponse)(conn, {
...
exports.me = me;
async function reply(conn, channelName, messageID, message) {
