...
export declare function say(conn: SingleConnection, channelName: string, messageText: string, replyToID?: string, action?: boolean): Promise<UserstateMessage>;
export declare function me(conn: SingleConnection, channelName: string, message: string): Promise<UserstateMessage>;
export declare function reply(conn: SingleConnection, channelName: string, messageID: string, message: string): Promise<UserstateMessage>;
